...
public class Rute {
    ...
    // ⭐ FIXED: tarif adalah object, bukan Double
    @SerializedName("tarif")
    private TarifDetail tarif;

    // ============================================
    // INNER CLASS — TarifDetail
    // ============================================
    ...
    public static class TarifDetail {
        ...
        // ⭐ "harga" dari API berupa String ("85000.00"), bukan angka
        ...
        /**
         * Helper: konversi harga String → double.
         * Aman dipakai langsung di PersiapanActivity.
         */
    ...
    public List<TrackCoordinate> getTrackCoordinates()                      { return trackCoordinates; }
    public void setTrackCoordinates(List<TrackCoordinate> trackCoordinates) { this.trackCoordinates = trackCoordinates; }
    ...
    // ⭐ Getter tarif object
    public TarifDetail getTarif()               { return tarif; }
    public void setTarif(TarifDetail tarif)     { this.tarif = tarif; }

    /**
     * ⭐ Helper langsung ambil harga sebagai double.
     * Aman walau tarif null.
     */
    public double getTarifHarga() {
        if (tarif == null) return 0.0;
        return tarif.getHargaAsDouble();
    }
